<script type="text/javascript">
    ...
    (function () {
        ...
        function milestone_kanban_init() {
            ...
            $current_time = time();
            $text .= '<a data-milestones-id="' . $mid . '"   data-task-id="' . $mv_task->task_id . '" style="word-wrap: break-word;" class="text-info" href="' . base_url() . 'admin/tasks/view_task_details/' . $mv_task->task_id . '">' . $mv_task->task_name . '</a>';
