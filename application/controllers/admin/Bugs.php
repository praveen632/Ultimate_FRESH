...
// Update into tbl_project
    ...
    public function save_comments()
    {
        ...
        if (!empty($_FILES['comments_attachment']['name']['0'])) {
            ...
            $mul_val = $this->bugs_model->multi_uploadAllType('comments_attachment');
...
// Update into tbl_project
        ...
        set_message($type, $message);
        redirect('admin/bugs/view_bug_details/' . $data['bug_id'] . '/' . 2);
    }
...
// save into activities
        $activities = array(
            ...
            'icon' => 'fa-bug',
            'link' => 'admin/bugs/view_bug_details/' . $bug_id . '/3',
