                    ...
                    <tr class="sortable item" data-item-id="<?= $my_todo->todo_id ?>">
                        ...
                        <td>
                            <strong data-toggle="tooltip" data-placement="top"
                                    title="<?= strftime(config_item('date_format'), strtotime($my_todo->due_date)) ?>"><?= date("l", strtotime($my_todo->due_date)) ?>
                                <?php if ($my_todo->status != 3) { ?>
                                    <span class="block"><?= daysleft($my_todo->due_date) ?></span>
                                <?php } ?>
                            </strong>
