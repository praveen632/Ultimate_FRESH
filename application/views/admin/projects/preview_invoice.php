                        ...
                        if (!empty($items_name)) {
                            if ($items_name == 'single_line') {
                                ...
                                <tr class="hidden-print">
                                    ...
                                    <td><span class="linetotal"><?php echo $project_info->project_cost * 1; ?></span>
                                    </td>
                                        ...
                                        if (!empty($total_tasks_timer)) {
                                            foreach ($total_tasks_timer as $v_task_timer) {
                                                ...
                                                <textarea name="item_name[]" placeholder="Item Name"
                                                    ...
                                                    <td><textarea rows="1" name="item_desc[]"
                                                            ...
                                                            ?></textarea></td>
                                                    <td><input type="number" data-parsley-type="number"
                                                               name="quantity[]"
                                                               value="<?php
                                                               echo $qty;
                                                               ?>" placeholder="1"
                                                        ...
                                                        <select name="item_tax_rate[]" class="form-control  ">
                                                            ...
                                                            if (!empty($tax_rates)) {
                                                                foreach ($tax_rates as $v_tax) {
                                                                    ?>
                                                                    <option
                                                                        value="<?= $v_tax->tax_rate_percent ?>" <?php
                                                                    if (!empty($item_info) && $item_info->item_tax_rate == $v_tax->tax_rate_percent) {
                                                                        echo 'selected';
                                                                    }
                                                                    ?>><?= $v_tax->tax_rate_name . ' (' . $v_tax->tax_rate_percent . '%)' ?></option>
                                                    ...
                                                    <td class="hidden-print">
                                                        <a href="javascript:void(0);"
                                                           class="remCF btn btn-danger btn-xs"><i
                                                                class="fa fa-trash-o"></i></a>
                                                    </td>
                                                </tr>
