    ...
    <tr>
        <td style="width: 40%">
            ...
            <div class="name"><strong><?= lang('created_date') ?>
                    :</strong><?= strftime(config_item('date_format'), strtotime($project_details->created_time)) . ' ' . lang('on') . ' ' . date('h:i A', strtotime($project_details->created_time)) ?>
            </div>
            ...
            foreach ($total_timer as $v_timer) {
                ...
                if (!empty($aproject_info)) {
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><?= strftime(config_item('date_format') . ' %H:%M', $v_timer->start_time) ?></td>
                        <td style="text-align: center"><?= strftime(config_item('date_format') . ' %H:%M', $v_timer->end_time) ?></td>
