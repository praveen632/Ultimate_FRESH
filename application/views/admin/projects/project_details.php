...
$comment_details = $this->db->where(array('project_id' => $project_details->project_id, 'comments_reply_id' => '0'))->order_by('comment_datetime', 'DESC')->get('tbl_task_comment')->result();
...
<?php
    $progress = $this->items_model->estimated_details($project_details->project_id);
    
?>
   
    <div class="ml-lg mb-lg text-center">
        <p class="p0 m0">
            <strong><?php echo "Estimate Cast"; ?></strong>: <?= display_money($progress['total_estimates_cost'], $currency->symbol) ?>
        </p>
        <p class="p0 m0">
            <strong><?php echo "Resource Cast"; ?></strong>: <?= display_money($progress['total_resource_cost'], $currency->symbol) ?>
        </p>
        <p class="p0 m0">
            <strong><?=  lang('expense') ?></strong>: <?= display_money($total_expense->amount, $currency->symbol) ?>
        </p>
                <?php
                  $total_cost = $progress['total_resource_cost'] + $total_expense->amount;       
                ?>
        <p class="p0 m0">
            <h2><strong><?php echo "Actual Cost "; ?></strong>: <?= display_money($total_cost, $currency->symbol) ?></h2>
        </p>
                            ...
                            foreach ($activities_info as $v_activities) {
                                ...
                                <div class="timeline-2">
                                    <div class="time-item">
                                        <div class="item-info">
                                            <small
                                                class="text-muted"><?= $this->items_model->get_time_different(time(), strtotime($v_activities->activity_date)); ?></small>
                ...
                <div class="panel panel-custom">
                    ...
                    <div class="panel-body chat" id="chat-box">
                        ...
                        <form enctype="multipart/form-data" id="form_validation"
                              action="<?php echo base_url() ?>admin/projects/save_comments"
                        ...
                        if (!empty($comment_details)) {
                            foreach ($comment_details as $key => $v_comment) {
                                ...
                                <div class="mb-mails col-sm-12">
                                    ...
                                    <div
                                        class="mb-mail-date pull-right"><?= $this->items_model->get_time_different(time(), strtotime($v_comment->comment_datetime)) ?>

                                        <?php if ($v_comment->user_id == $this->session->userdata('user_id')) { ?>
                                            <a class="text-danger"
                                               href="<?= base_url() ?>admin/projects/delete_comments/<?= $v_comment->project_id . '/' . $v_comment->task_comment_id ?>"><i
                                        ...
                                        <div class="mb-mail-album pull-left">
                                            ...
                                            if (!empty($uploaded_file)) {
                                                foreach ($uploaded_file as $v_files) {
                                                    if (!empty($v_files)) {
                                                        ?>
                                                        <a href="<?= base_url() ?>admin/projects/download_files/<?= $v_comment->project_id . '/' . $v_files->fileName . '/' . true ?>">
                                            ...
                                            foreach ($comment_reply_details as $v_reply) {
                                                ...
                                                <div class="mb-mails col-sm-11">
                                                    <img alt="Mail Avatar"
                                                         ...
                                                         class="mb-mail-avatar pull-left">
                                                    <div
                                                        class="mb-mail-date pull-right"><?= $this->items_model->get_time_different(time(), strtotime($v_reply->comment_datetime)) ?>

                                                        <?php if ($v_reply->user_id == $this->session->userdata('user_id')) { ?>
                                                            <a class="text-danger"
                                                               href="<?= base_url() ?>admin/projects/delete_comments/<?= $v_reply->project_id . '/' . $v_reply->task_comment_id ?>"><i
                                                                    class="fa fa-trash-o"></i></a>
                                                        <?php } ?>
                                                    </div>
                                                    <div class="mb-mail-meta">
                                                ...
                                                <a data-toggle="collapse" data-parent="#accordion"
                                                   ...
                                                   aria-controls="collapseOne">
                                                    <strong data-toggle="tooltip" data-placement="top"
                                                            ...
                                                            . lang('uploaded_by') . ' : ' . $user_info->username ?>"><?php echo $files_info[$key]->title; ?> </strong>
                                                            ...
                                                            if (!empty($v_files)):
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="mailbox-attachment-info">
                                                                        <a href="<?= base_url() ?>admin/projects/download_files/<?= $files_info[$key]->project_id ?>/<?= $v_files->uploaded_files_id ?>"
                                                                           class="mailbox-attachment-name"><i
                                                                                class="fa fa-paperclip"></i>
                                                                            <?= $v_files->file_name ?></a>
                                                                        <p class="text-sm"><?= date('Y-m-d' . "<br/> h:m A", strtotime($files_info[$key]->upload_time)); ?></p>
