...
$comment_details = $this->db->where(array('task_id' => $task_details->task_id, 'comments_reply_id' => '0'))->order_by('comment_datetime', 'DESC')->get('tbl_task_comment')->result();
            ...
            <div class="tab-pane <?= $active == 1 ? 'active' : '' ?>" id="task_details"
                ...
                <div class="panel panel-custom">
                    ...
                    <div class="panel-body row form-horizontal task_details">
                        ...
                        <?php endif ?>
                        <div class="form-group  col-sm-6">
                            <label class="control-label col-sm-5"><strong><?php echo "Start Date & Time"; ?>
                                    :</strong></label>
                            <div class="col-sm-7 ">
                        ...
                        <div class="form-group  col-sm-6">
                            ...
                            <?php if($task_details->task_status == 'in_progress'){ ?>
                              <div class="form-group  col-sm-6">
                                    <label class="control-label col-sm-5"><strong><?php echo "In Progress"; ?>
                                            :</strong></label>
                                    <div class="col-sm-7 ">
                                        <p class="form-control-static"><?php
                                            if (!empty($task_details->task_update_time)) {
                                                echo $task_details->task_update_time;
                                            }
                                            ?></p>
                            ...
                            <?php }else{ ?>
                                    <div class="form-group  col-sm-6">
                                        <label class="control-label col-sm-5"><strong><?php echo "completed"; ?>
                                                :</strong></label>
                                        <div class="col-sm-7 ">
                                            <p class="form-control-static"><?php
                                                if (!empty($task_details->task_update_time)) {
                        ...
                        if (!empty($comment_details)) {
                            foreach ($comment_details as $key => $v_comment) {
                                ...
                                <div class="mb-mails col-sm-12">
                                    ...
                                    <div
                                        class="mb-mail-date pull-right"><?= $this->tasks_model->get_time_different(time(), strtotime($v_comment->comment_datetime)) ?>

                                        <?php if ($v_comment->user_id == $this->session->userdata('user_id')) { ?>
                                            <a class="text-danger"
                                               href="<?= base_url() ?>admin/tasks/delete_task_comments/<?= $v_comment->task_id . '/' . $v_comment->task_comment_id ?>"><i
                                        ...
                                        <div class="mb-mail-album pull-left">
                                            ...
                                            if (!empty($uploaded_file)) {
                                                foreach ($uploaded_file as $v_files) {
                                                    if (!empty($v_files)) {
                                                        ?>
                                                        <a href="<?= base_url() ?>admin/tasks/download_files/<?= $v_comment->task_id . '/' . $v_files->fileName . '/' . true ?>">
                                            ...
                                            foreach ($comment_reply_details as $v_reply) {
                                                ...
                                                <div class="mb-mails col-sm-11">
                                                    <img alt="Mail Avatar"
                                                         ...
                                                         class="mb-mail-avatar pull-left">
                                                    <div
                                                        class="mb-mail-date pull-right"><?= $this->tasks_model->get_time_different(time(), strtotime($v_reply->comment_datetime)) ?>

                                                        <?php if ($v_reply->user_id == $this->session->userdata('user_id')) { ?>
                                                            <a class="text-danger"
                                                               href="<?= base_url() ?>admin/tasks/delete_task_comments/<?= $v_reply->task_id . '/' . $v_reply->task_comment_id ?>"><i
                                                                    class="fa fa-trash-o"></i></a>
                                                        <?php } ?>
                                                    </div>
                                                    <div class="mb-mail-meta">
                            ...
                            foreach ($activities_info as $v_activities) {
                                ...
                                <div class="timeline-2">
                                    <div class="time-item">
                                        <div class="item-info">
                                            <small
                                                class="text-muted"><?= $this->tasks_model->get_time_different(time(), strtotime($v_activities->activity_date)); ?></small>
