...
<link href="<?php echo base_url() ?>assets/picker/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css">
<link href="<?php echo base_url() ?>assets/picker/css/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css">
            ...
            <div class="nav-tabs-custom">
                            ...
                            <div class="box" style="border: none; padding-top: 15px;" data-collapsed="0">
                                <div class="panel-body">
                                    <form data-parsley-validate="" novalidate=""
                                        ...
                                        <?php endif ?>
                                        <div class="form-group">
                <label for="dtp_input1" class="col-md-3 control-label"><?= lang('start_date') ?></label>
                <div class="col-lg-5">
                <div class="input-group date form_datetime"  data-date-format="yyyy-mm-dd - HH:ii p" data-link-field="dtp_input1">
                    <input class="form-control" size="16" type="text" value="" name="task_start_date" readonly>
                ...
                <input type="hidden" id="dtp_input1" value="" /><br/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5 slider-reversed">
...
<script src="<?= base_url() ?>assets/picker/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="<?= base_url() ?>assets/picker/bootstrap-datetimepicker.js" charset="UTF-8" type="text/javascript"></script>
<script src="<?= base_url() ?>assets/picker/locales/bootstrap-datetimepicker.fr.js" charset="UTF-8" ></script>
