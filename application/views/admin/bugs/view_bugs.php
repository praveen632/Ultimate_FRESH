                        ...
                        if (!empty($comment_details)) {
                            foreach ($comment_details as $key => $v_comment) {
                                ...
                                <div class="mb-mails col-sm-12">
                                    ...
                                    <div
                                        class="mb-mail-date pull-right"><?= $this->bugs_model->get_time_different(time(), strtotime($v_comment->comment_datetime)) ?>

                                        <?php if ($v_comment->user_id == $this->session->userdata('user_id')) { ?>
                                            <a class="text-danger"
                                               href="<?= base_url() ?>admin/bugs/delete_bug_comments/<?= $v_comment->bug_id . '/' . $v_comment->task_comment_id ?>"><i
                                        ...
                                        <div class="mb-mail-album pull-left">
                                            ...
                                            if (!empty($uploaded_file)) {
                                                foreach ($uploaded_file as $v_files) {
                                                    if (!empty($v_files)) {
                                                        ?>
                                                        <a href="<?= base_url() ?>admin/bugs/download_files/<?= $v_comment->bug_id . '/' . $v_files->fileName . '/' . true ?>">
                                            ...
                                            foreach ($comment_reply_details as $v_reply) {
                                                ...
                                                <div class="mb-mails col-sm-11">
                                                    <img alt="Mail Avatar"
                                                         ...
                                                         class="mb-mail-avatar pull-left">
                                                    <div
                                                        class="mb-mail-date pull-right"><?= $this->bugs_model->get_time_different(time(), strtotime($v_reply->comment_datetime)) ?>

                                                        <?php if ($v_reply->user_id == $this->session->userdata('user_id')) { ?>
                                                            <a class="text-danger"
                                                               href="<?= base_url() ?>admin/bugs/delete_bug_comments/<?= $v_reply->bug_id . '/' . $v_reply->task_comment_id ?>"><i
                                                                    class="fa fa-trash-o"></i></a>
                                                        <?php } ?>
                                                    </div>
                                                    <div class="mb-mail-meta">
                                                                ...
                                                                <tr class="file-item">
                                                                    <td>
                                                                        ...
                                                                        <a data-toggle="tooltip"
                                                                           ...
                                                                           class="text-info"
                                                                           href="<?= base_url() ?>admin/bugs/download_files/<?= $files_info[$key]->bug_id ?>/<?= $v_files->uploaded_files_id ?>">
                                                                    ...
                                                                    <td>
                                                                        <a class="btn btn-xs btn-dark"
                                                                           ...
                                                                           href="<?= base_url() ?>admin/bugs/download_files/<?= $files_info[$key]->bug_id ?>/<?= $v_files->uploaded_files_id ?>"><i
                                ...
                                foreach ($activities_info as $v_activities) {
                                    ...
                                    <div class="timeline-2">
                                        <div class="time-item">
                                            <div class="item-info">
                                                <small
                                                    class="text-muted"><?= $this->bugs_model->get_time_different(time(), strtotime($v_activities->activity_date)); ?></small>
