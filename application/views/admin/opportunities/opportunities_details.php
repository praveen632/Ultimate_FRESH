...
$comment_details = $this->db->where(array('opportunities_id' => $opportunity_details->opportunities_id, 'comments_reply_id' => '0'))->order_by('comment_datetime', 'DESC')->get('tbl_task_comment')->result();
                                    ...
                                    <div class="mb-mails col-sm-12">
                                        ...
                                        <div
                                            ...
                                            <?php if ($v_comment->user_id == $this->session->userdata('user_id')) { ?>
                                                <a class="text-danger"
                                                   href="<?= base_url() ?>admin/opportunities/delete_comments/<?= $v_comment->opportunities_id . '/' . $v_comment->task_comment_id ?>"><i
                                            ...
                                            <div class="mb-mail-album pull-left">
                                                ...
                                                if (!empty($uploaded_file)) {
                                                    foreach ($uploaded_file as $v_files) {
                                                        if (!empty($v_files)) {
                                                            ?>
                                                            <a href="<?= base_url() ?>admin/opportunities/download_files/<?= $v_comment->opportunities_id . '/' . $v_files->fileName . '/' . true ?>">
                                                    ...
                                                    <div class="mb-mails col-sm-11">
                                                        ...
                                                        <div
                                                            ...
                                                            <?php if ($v_reply->user_id == $this->session->userdata('user_id')) { ?>
                                                                <a class="text-danger"
                                                                   href="<?= base_url() ?>admin/opportunities/delete_comments/<?= $v_reply->opportunities_id . '/' . $v_reply->task_comment_id ?>"><i
                                                                        class="fa fa-trash-o"></i></a>
                                                            <?php } ?>
                                                        </div>
                                                        <div class="mb-mail-meta">
                                                                    ...
                                                                    <tr class="file-item">
                                                                        <td>
                                                                            ...
                                                                            <a data-toggle="tooltip"
                                                                               ...
                                                                               class="text-info"
                                                                               href="<?= base_url() ?>admin/opportunities/download_files/<?= $files_info[$key]->opportunities_id ?>/<?= $v_files->uploaded_files_id ?>">
                                                                        ...
                                                                        <td>
                                                                            <a class="btn btn-xs btn-dark"
                                                                               ...
                                                                               href="<?= base_url() ?>admin/opportunities/download_files/<?= $files_info[$key]->opportunities_id ?>/<?= $v_files->uploaded_files_id ?>"><i
