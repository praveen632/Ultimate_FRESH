...
$comment_details = $this->db->where(array('leads_id' => $leads_details->leads_id, 'comments_reply_id' => '0'))->order_by('comment_datetime', 'DESC')->get('tbl_task_comment')->result();
    ...
    <div class="col-sm-3">
        ...
        if ($leads_details->converted_client_id == 0) {
            if (!empty($can_edit) && !empty($edited)) { ?>
                <a href="<?= base_url() ?>admin/leads/index/<?= $leads_details->leads_id ?>" class="btn-xs btn btn-primary"
                   title=""
                                ...
                                <div class="mb-mails col-sm-12">
                                    ...
                                    <div
                                        ...
                                        <?php if ($v_comment->user_id == $this->session->userdata('user_id')) { ?>
                                            <a class="text-danger"
                                               href="<?= base_url() ?>admin/leads/delete_comments/<?= $v_comment->leads_id . '/' . $v_comment->task_comment_id ?>"><i
                                        ...
                                        <div class="mb-mail-album pull-left">
                                            ...
                                            if (!empty($uploaded_file)) {
                                                foreach ($uploaded_file as $v_files) {
                                                    if (!empty($v_files)) {
                                                        ?>
                                                        <a href="<?= base_url() ?>admin/leads/download_files/<?= $v_comment->leads_id . '/' . $v_files->fileName . '/' . true ?>">
                                                ...
                                                <div class="mb-mails col-sm-11">
                                                    ...
                                                    <div
                                                        ...
                                                        <?php if ($v_reply->user_id == $this->session->userdata('user_id')) { ?>
                                                            <a class="text-danger"
                                                               href="<?= base_url() ?>admin/leads/delete_comments/<?= $v_reply->leads_id . '/' . $v_reply->task_comment_id ?>"><i
                                                                    class="fa fa-trash-o"></i></a>
                                                        <?php } ?>
                                                    </div>
                                                    <div class="mb-mail-meta">
                                                                ...
                                                                <tr class="file-item">
                                                                    <td>
                                                                        ...
                                                                        <a data-toggle="tooltip"
                                                                           ...
                                                                           class="text-info"
                                                                           href="<?= base_url() ?>admin/leads/download_files/<?= $files_info[$key]->leads_id ?>/<?= $v_files->uploaded_files_id ?>">
                                                                    ...
                                                                    <td>
                                                                        <a class="btn btn-xs btn-dark"
                                                                           ...
                                                                           data-placement="top"
                                                                           title="Download"
                                                                           href="<?= base_url() ?>admin/leads/download_files/<?= $files_info[$key]->leads_id ?>/<?= $v_files->uploaded_files_id ?>"><i
                                    ...
                                    if (!empty($all_reminder)) {
                                        foreach ($all_reminder as $v_reminder):
                                            ...
                                            <tr>
                                                ...
                                                <td><?= strftime(config_item('date_format'), strtotime($v_reminder->date)) . ' ' . date('H:i', strtotime($v_reminder->date)) ?></td>
                                                <td>
