...
if (!empty($created) || !empty($edited)){
    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content bg-white">
                ...
                <div class="panel panel-custom">
                    ...
                    <table class="table table-striped DataTables " id="DataTables" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th class="col-sm-1"><?php echo "Per Hour Rate" ?></th>
                        ...
                        if (!empty($all_user_info)): foreach ($all_user_info as $v_user) :
                            ...
                            if (!empty($account_info)) {
                                ...
                                <td><?= $account_info->per_hour_rate ?></td>
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label"><strong><?php echo "Per Hour Rate"; ?> </strong></label>
                <div class="col-sm-5">
                    <input type="text" class="input-sm form-control" value="<?php
                    if (!empty($profile_info)) {
                        echo $profile_info->per_hour_rate;
                    }
                    ?>" name="per_hour_rate"
                           placeholder="<?php echo "Per Hour Rate"; ?> <?= lang('user_placeholder_mobile') ?>">
                </div>
            </div>
                            <div class="form-group">
